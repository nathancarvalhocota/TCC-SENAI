...
namespace tcc_vacina
{
    public partial class CriarConta : Form
    {
        ...
        private void buttonCriarConta_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Hospital inválido!", " Campo área do usuário ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            /*    else if (textBoxCodigo.Visible == true & textBoxCodigo.Text != "admin")
                {

                    MessageBox.Show("Você inseriou o código de administrador errado");
                    textBoxCodigo.Text = "";
